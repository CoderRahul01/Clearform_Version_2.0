            ...
            {isLoading ? (
              <div className="flex items-center gap-4 px-[21px] py-[17px]">
                ...
                <div className="flex-1 flex flex-col gap-[6px] min-w-0">
                  <Shimmer className="h-[14px] w-[140px] rounded-[5px]" />
                  <Shimmer className="h-[12px] w-[190px] rounded-[4px]" />
                </div>
                <Shimmer className="h-[32px] w-[128px] rounded-lg shrink-0" />
                <Shimmer className="w-[22px] h-[22px] rounded-full shrink-0" />
              </div>
            ) : (
              <>
                {/* Collapsed row */}
